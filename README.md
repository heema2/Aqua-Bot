...
[![Version](https://img.shields.io/badge/version-1.2.42-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.42</strong></summary>

<br />

- **Announcements** button emojis fixed for Discord REST API (no more Invalid Form Body on send)
- Announcements permission checks fixed (v1.2.40–1.2.41)
