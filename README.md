...
[![Version](https://img.shields.io/badge/version-1.2.93-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.93</strong></summary>

<br />

- **Automod A–Z fix** — actions match the dashboard exactly (delete-only invite no longer times out); rule editor **Save rule** is live; content rules run before Anti-Spam
- **Automod** — timeouts only notify when Discord actually mutes; spam lockout if timeout fails
- **Supporters Rating** — `/rate` + period leaderboards, top role + announce channel
- **Multi-panel tickets** — multiple ticket panels with separate settings
