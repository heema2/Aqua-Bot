...
[![Version](https://img.shields.io/badge/version-1.2.41-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.41</strong></summary>

<br />

- **Announcements** dashboard send fixed (`permissions.has is not a function`)
- Announcements permission check fixed for Administrator bots (v1.2.40)
