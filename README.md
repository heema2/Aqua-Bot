...
[![Version](https://img.shields.io/badge/version-1.2.39-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.39</strong></summary>

<br />

- **Auto Responder** select menu replies with configured bot responses; only the triggering member can use the menu
- **Announcements** dashboard supports buttons only (select menu removed)
- Announcements dashboard, Welcome rename, and scheduled message fixes (v1.2.38)
