...
[![Version](https://img.shields.io/badge/version-1.2.38-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.38</strong></summary>

<br />

- **Announcements** dashboard — send embeds with buttons, menus, and @everyone / @here / role pings
- Welcome module renamed to **Welcome** only (announcements are separate)
- Auto Responder buttons/select menu and Scheduled Messages Start flow (v1.2.37)
