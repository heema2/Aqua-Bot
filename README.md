...
[![Version](https://img.shields.io/badge/version-1.2.40-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.2.40</strong></summary>

<br />

- **Announcements** dashboard send/edit fixed when the bot has Administrator (permission check no longer hits invalid Discord API route)
- Auto Responder select menu replies and owner-only menus (v1.2.39)
