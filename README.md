...
[![Version](https://img.shields.io/badge/version-1.3.17-0ea5e9?style=for-the-badge)](https://github.com/heema2/Aqua-Bot)
...
<details open>
<summary><strong>Latest — v1.3.17</strong></summary>

<br />

- **Automod full audit** — fixed cancel-editor wipe bug, @everyone mention counting, off-by-one in excessive length, `/automod set` writing punishments correctly, and `/automod view` showing multi-action rules
- **Automod cards** — each rule now shows its threshold at a glance (spam rate, mention limit, caps %, length cap)
